...
che invieremo attraverso il canale di comunicazione.
...
> *L’inviluppo complesso* è una rappresentazione puramente matematica del segnale in banda passante. 

Qui ci sono dei passaggi che fanno vedere come dall’inviluppo complesso si ricava la modulazione QAM.

Da questi calcoli notiamo immediatamente il motivo per cui nella modulazione QAM mettevamo un meno davanti al seno. 
...
- AM-DSB: 
	$s_{DSB}(t) = m(t)cos(2 \pi f_c t)$ quindi il suo inviluppo complesso sarà esattamente $\tilde{s}_{DSB}(t) = m(t)$ da cui $s_I(t) = m(t)$ e $s_Q(t) = 0$.
- QAM: 
	$s_{QAM}(t) = m_1(t)cos(2 \pi f_c t) - m_2(t)sin(2\pi f_c t)$ quindi il suo inviluppo complesso sarà esattamente $\tilde{s}_{QAM}(t) = m_1(t) + jm_2(t)$ da cui $s_I(t) = m_1(t)$ e $s_Q(t) = m_2(t)$.
...
Domanda: che tipo di segnale è? 
È un segnale *passa banda* perché compare $f_c$.
